...
int main()
{
    ...
    //copy constructor i�in islem yapar
    prime yeni(sayilar);//ilk prime degiskeni olan 0-100 i�eren sinifi kopyalar
    yeni.minMaxYazdir();
    sayilar=yeni.sinirBuyut(sayilar);//min=min max=max+max olacak sekilde �st limit artirilir
    sayilar.minMaxYazdir();
    cout << sayilar.min << "-" <<sayilar.max<<" arasindaki asal sayilar"<< endl;
    sayilar.primeBul(sayilar.min,sayilar.max);
    return 0;
