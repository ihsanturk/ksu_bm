```c
/*
 * Konu: Ctype Kütüphanesi Fonksiyonları
 * Tarih: 2018.12.28
 */
...
int main()
{
  ...
  int isdigit(test); // Returns a true value if c is a digit and 0 (false) otherwise.
  int isalpha(test); // Returns a true value if c is a letter and 0 otherwise.
  ...
  int isxdigit( int c );// Returns a true value if c is a hexadecimal digit character and 0
            ...
            // explanation of binary numbers, octal numbers, decimal numbers
