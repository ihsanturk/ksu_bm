...
int *iki_diziyi_topla(int pozitif_dizi[], int negatif_dizi[], int toplam_dizi[]);
...
int main()
{
	...
	p = iki_diziyi_topla(pozitif_dizi, negatif_dizi, toplam_dizi);
